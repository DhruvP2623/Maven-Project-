/*Java program to see the Email to friend function is working by entering details automatic
and in console it will come Only registered customers can use email a friend feature */
...
public class Emailtofriend {
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.id("FriendEmail")).sendKeys("Ansh123@gmail.com");
        //findElement command is used to uniquely identify a web element within the web page
        ...
        into an editable field while executing any tests for form */
        driver.findElement(By.id("YourEmailAddress")).sendKeys("dhruvpatel12345@gmail.com");
        //findElement command is used to uniquely identify a web element within the web page
        ...
        into an editable field while executing any tests for form */
        driver.findElement(By.id("PersonalMessage")).sendKeys("Bro it's a good product");
        //findElement command is used to uniquely identify a web element within the web page
